...
/**
 * Tutorial model. This plays "Brain Damage" by Pink Floyd while displaying
 * instructions to the user. This method is mostly a copy from the play model.
 *
 * @author Emma and Ben, modified to work for tutorial mode by Jelena
 */
public class TutorialModel {
    private Song mainSong = new Song("tutorial/Brain Damage");
    ...
    public void startSong() {
        ...
        try {
            ...
            Thread notesThread = getNotesAnimationThread(mainSong);
            notesThread.start();
            new Thread(() -> {
                try {
    ...
    /**
     * Trigger next tutorial instruction
     * 
     * @author Jelena
     */
    public void nextInstruction(boolean zeroPower) {
        support.firePropertyChange("instruction", null, infoCounter);
        if (infoCounter == Instructions.getLen()) {
            infoCounter = 0;
        } else {
            infoCounter += 1;
        }
